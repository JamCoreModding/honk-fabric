...
def get_item_texture(item: str):
	...
	response = requests.get(f'https://github.com/InventivetalentDev/minecraft-assets/blob/1.20.1/assets/minecraft/textures/item/{item}.png?raw=true')
